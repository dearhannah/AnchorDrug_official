...
#----------------------------------------------------------------------------------------------------------------
    ...
    df_test = None
    for cell in c:
        tmp = pd.read_csv('/egr/research-aidd/chenruo4/AnchorDrug/data/newTestData/' + cell + '_test.csv', index_col = 'Unnamed: 0')
        median = tmp[['SMILES', g,]].groupby(by='SMILES').median().reset_index()
        median['cellline'] = cell
        median['test_gene'] = g
        if df_test is None:
...
def main(args):
    ...
    for rdseed in [10]: #set seed = 10
        ...
        # out setting
        model_str = 'pretrain_all_978_genes_seed_' + str(rdseed)
        #model_str = 'pretrain_all_5_genes_seed_' + str(rdseed)
        ...
        for e in range(args.n_epoch):
            ...
            test_acc, test_f1, test_f1_per_gene, test_acc_per_gene = evaluate(net, test_loader)
        ...
        pd.DataFrame({'training_loss': summary_train_loss}, index = range(0, e+1)).to_csv(out_dir + 'training_loss_per_epoch.csv')
...
if __name__ == '__main__':
    ...
    #argparser.add_argument('--out_dir', type=str, help='dir to output', default='/egr/research-aidd/chenruo4/AnchorDrug/base_model/revise_MLP_128_64_32_normalized_cell_line_embeddings_ECFP_GO_terms_5_genes/MLP_1000_128_64/')
    argparser.add_argument('--out_dir', type=str, help='dir to output', default='/egr/research-aidd/chenruo4/AnchorDrug/base_model/revise_MLP_128_64_32_normalized_cell_line_embeddings_ECFP_GO_terms_978_genes/MLP_1000_128_64_20230124/')
