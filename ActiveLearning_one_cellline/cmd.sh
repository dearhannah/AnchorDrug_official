...
python ActiveLearning.py -a=RandomSampling -s=0 -q=810 -b=30 -d=LINCS -c MCF7 --seed=4678 -t=5 -g=5 -bs
python ActiveLearning.py -a=RandomSampling -s=0 -q=957 -b=30 -d=LINCS -c PC3 --seed=4996 -t=5 -g=6 -bs
python ActiveLearning.py -a=RandomSampling -s=0 -q=642 -b=30 -d=LINCS -c A549 --seed=4786 -t=5 -g=7 -bs