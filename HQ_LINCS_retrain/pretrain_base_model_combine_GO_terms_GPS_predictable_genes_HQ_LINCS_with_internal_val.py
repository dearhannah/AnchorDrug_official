...
def evaluate(model, loader, type):
    ...
    loss = loss.detach().numpy().flatten()
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--out_dir', type=str, help='dir to output', default='/egr/research-aidd/chenruo4/AnchorDrug/base_model/revise_downsampling_MLP_1000_128_64_normalized_cell_line_embeddings_ECFP_GO_terms_GPS_predictable_307_genes_HQ_LINCS/internal_val_10%_random_holdout_earlystop/')
